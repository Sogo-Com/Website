	...
	<div>
		<div class="privacy-policy">
			<div>
				...
				<p>
					<br /><br /><strong>{donneesPerso["$website$"]}</strong><br />{donneesPerso["$nomEntreprise$"]}<br /><br />
			...
			<p>
				<br /><em>Date d’entrée en vigueur : </em>le 14 janvier 2024
			</p>
		</div>
	</div>
</div>
