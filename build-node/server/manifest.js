	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-4668788e.js'))
			},
			{
				id: "/(api)/api/contact",
				pattern: /^\/api\/contact\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server-ec2c0ba2.js'))
			},
			{
...
const prerendered = new Set(["/","/__data.json","/agence","/agence/__data.json","/competences","/competences/__data.json","/contact","/contact/__data.json","/donnees-personelles","/donnees-personelles/__data.json","/expertises","/expertises/__data.json","/mentions","/mentions/__data.json","/presse","/presse/__data.json","/projets","/projets/__data.json"]);
