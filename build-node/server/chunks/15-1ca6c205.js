...
const index = 15;
let component_cache;
const component = async () => component_cache ??= (await import('./_page.svelte-0e8bc2bd.js')).default;
...
const imports = ["_app/immutable/nodes/15.c5434d06.js","_app/immutable/chunks/index.c3d3dcff.js","_app/immutable/chunks/utils.f2137142.js"];
const stylesheets = ["_app/immutable/assets/15.4a2fd6a3.css","_app/immutable/assets/FlipCard.96033987.css"];
const fonts = [];

export { component, fonts, imports, index, _page_server as server, server_id, stylesheets, _page as universal, universal_id };
//# sourceMappingURL=15-1ca6c205.js.map
