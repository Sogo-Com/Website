import { c as create_ssr_component } from './index3-7ceb3c84.js';

const css = {
  code: '@import url("https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Comfortaa&display=swap");@import url("/styles/reset.scss");@import url("/styles/base.scss");@font-face{font-family:"ElMessiri-Bold";src:url("/fonts/ElMessiri-Bold.ttf");font-style:normal;font-weight:700;font-display:swap}@font-face{font-family:"ElMessiri-SemiBold";src:url("/fonts/ElMessiri-SemiBold.ttf");font-style:normal;font-weight:600;font-display:swap}@font-face{font-family:"ElMessiri-Medium";src:url("/fonts/ElMessiri-Medium.ttf");font-style:normal;font-weight:500;font-display:swap}@font-face{font-family:"Poppins-Regular";src:url("/fonts/Poppins-Regular.ttf");font-style:normal;font-weight:400;font-display:swap}@font-face{font-family:"Poppins-Bold";src:url("/fonts/Poppins-Bold.ttf");font-style:normal;font-weight:700;font-display:swap}@font-face{font-family:"Poppins-SemiBold";src:url("/fonts/Poppins-SemiBold.ttf");font-style:normal;font-weight:600;font-display:swap}@font-face{font-family:"Poppins-Medium";src:url("/fonts/Poppins-Medium.ttf");font-style:normal;font-weight:500;font-display:swap}@font-face{font-family:"Poppins-Regular";src:url("/fonts/Poppins-Regular.ttf");font-style:normal;font-weight:400;font-display:swap}@font-face{font-family:"Poppins-Light";src:url("/fonts/Poppins-Light.ttf");font-style:normal;font-weight:400;font-display:swap}:root{--color-rose:#DDB0AF;--color-violet:#A48BAD;--color-jaune:#E5AE1E;--color-gris:#878787;--color-bordeaux:#9D524F;--color-bleu:#2C9A9B;--color-kaki:#80816D;--color-blanc:#F5F5F5;--color-gris-dark:#575757;--color-gris-clair:#E1E1E1;--font-primary-bold:"ElMessiri-Bold";--font-primary-semibold:"ElMessiri-SemiBold";--font-primary-medium:"ElMessiri-Medium";--font-primary-regular:"ElMessiri-Regular";--font-secondary-bold:"Poppins-Bold";--font-secondary-semibold:"Poppins-SemiBold";--font-secondary-medium:"Poppins-Medium";--font-secondary-regular:"Poppins-Regular";--font-secondary-light:"Poppins-Light";font-size:18px;--tablet:1150px;--phone:960px}@media only screen and (max-width: 1150px){:root{font-size:14px}}@media only screen and (max-width: 960px){:root{font-size:12px}}#top.svelte-lel9yo.svelte-lel9yo.svelte-lel9yo{height:100vh;width:100%;overflow:hidden;position:relative;display:flex;justify-content:start;align-items:end}@media only screen and (max-width: 960px){#top.svelte-lel9yo.svelte-lel9yo.svelte-lel9yo{align-items:center}}#top.svelte-lel9yo img.svelte-lel9yo.svelte-lel9yo{width:100%;height:100%;position:absolute;top:0;z-index:10;background-size:cover;object-fit:cover}.actualite.svelte-lel9yo.svelte-lel9yo.svelte-lel9yo{z-index:15;position:relative;border-radius:32px;padding:64px;margin:-400px 64px 64px 64px;background-color:#fff}.actualite.svelte-lel9yo h1.svelte-lel9yo.svelte-lel9yo{color:#575757;padding:8px 0}.actualite.svelte-lel9yo .actu-bar.svelte-lel9yo.svelte-lel9yo{margin:32px 0;border-top:solid #575757 1px;border-bottom:solid #575757 1px;display:flex;flex-direction:row;justify-content:space-around}.actualite.svelte-lel9yo .actu-bar div.svelte-lel9yo.svelte-lel9yo{padding:16px 0;display:flex;width:fit-content;align-items:center;font-family:"Poppins-Light";flex-grow:1;text-align:left}.actualite.svelte-lel9yo .actu-bar div.svelte-lel9yo img.svelte-lel9yo{padding:0 16px}.actualite.svelte-lel9yo .actu-bar .author.svelte-lel9yo.svelte-lel9yo{justify-content:left}.actualite.svelte-lel9yo .actu-bar .calendar.svelte-lel9yo.svelte-lel9yo{justify-content:center}.actualite.svelte-lel9yo .actu-bar .commentary.svelte-lel9yo.svelte-lel9yo{justify-content:right}.actualite.svelte-lel9yo p.svelte-lel9yo.svelte-lel9yo{font-size:0.8rem}',
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div id="top" class="svelte-lel9yo"><img alt="background-sogo" src="/images/agence-bg.png" class="svelte-lel9yo"></div>

<div class="actualite svelte-lel9yo"><h1 class="svelte-lel9yo">Titre du projet
	</h1>

	<div class="actu-bar svelte-lel9yo"><div class="author svelte-lel9yo"><img src="/images/author.svg" alt="author" class="svelte-lel9yo">
			Gaëlle Tagliabue
		</div>

		<div class="calendar svelte-lel9yo"><img src="/images/calendar.svg" alt="calendar" class="svelte-lel9yo">
			30 mai 2023
		</div>

		<div class="commentary svelte-lel9yo"><img src="/images/commentary.svg" alt="commentary" class="svelte-lel9yo">
			5 commentaires
		</div></div>

	<div class="contenu svelte-lel9yo"><p class="svelte-lel9yo">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec scelerisque facilisis orci at luctus. 
...
//# sourceMappingURL=_page.svelte-964912f6.js.map
