import { c as create_ssr_component, b as add_attribute, d as each, v as validate_component, e as escape } from './ssr-4049a6a7.js';
...
const ProjetRow = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"sub-project " + escape(isLeft == "true" ? "blanc" : "bleu", true) + " svelte-183u20j"}"><div class="${"images " + escape(isLeft == "false" ? "big" : "", true) + " svelte-183u20j"}"><img${add_attribute("src", imgLeft, 0)} alt="tomme" class="svelte-183u20j"></div> ${isLeft == "true" ? `<div class="trait svelte-183u20j"></div>` : ``} <div class="contenu svelte-183u20j"><h3 class="svelte-183u20j">${escape(title)}</h3> <div class="texte svelte-183u20j">${escape(description)}</div> <div class="btn bleu svelte-183u20j" data-svelte-h="svelte-6rnxy">En savoir +</div></div> ${isLeft == "false" ? `<div class="trait svelte-183u20j"></div>` : ``} <div class="${"images " + escape(isLeft == "true" ? "big" : "", true) + " svelte-183u20j"}"><img${add_attribute("src", imgRight, 0)} alt="tomme" class="svelte-183u20j"></div> </div>`;
});
const css = {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `<div id="top" class="svelte-50di88" data-svelte-h="svelte-1oxezj4"><h1 class="svelte-50di88">Nos projets</h1> <img alt="background-sogo" src="/images/projet-bg.png" class="svelte-50di88"></div> <div class="gris svelte-50di88" data-svelte-h="svelte-1uks2dd"><div class="question gris-child svelte-50di88"><h2 class="svelte-50di88">Que fait-on <br>
			chez Sogo Com ?</h2></div> <div class="reponse gris-child svelte-50di88"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec scelerisque facilisis orci at
			luctus.</p> <br> <p>Donec in euismod nibh. Ut mollis enim neque, et tincidunt nulla pulvinar condimentum.Lorem
			ipsum dolor sit amet, consectetur adipiscing elit. Donec scelerisque facilisis orci at luctus.</p> <br> <p>Donec in euismod nibh. Ut mollis enim neque, et tincidunt nulla pulvinar condimentum.Lorem
			ipsum dolor sit amet, consectetur adipiscing elit. Donec scelerisque facilisis orci at luctus.</p></div></div> <div class="projet svelte-50di88"${add_attribute("this", container, 0)}><div class="links svelte-50di88"${add_attribute("this", links, 0)}> <div class="link svelte-50di88" data-svelte-h="svelte-1okxq7m">Rédaction</div>  <div class="link svelte-50di88" data-svelte-h="svelte-1b57oq3">Relation de presse</div>  <div class="link svelte-50di88" data-svelte-h="svelte-1e7fhrd">Graphisme</div>  <div class="link svelte-50di88" data-svelte-h="svelte-1ogjq3v">Réseaux sociaux</div>  <div class="link svelte-50di88" data-svelte-h="svelte-y46agx">Photos et vidéos</div>  <div class="link svelte-50di88" data-svelte-h="svelte-xj8ow4">Évenements</div></div> ${each(projets, (projet, index) => {
...
//# sourceMappingURL=_page.svelte-28bfa8c4.js.map
