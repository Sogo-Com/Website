import { c as create_ssr_component, v as validate_component, a as subscribe, e as escape, b as add_attribute, d as each, o as onDestroy, f as add_styles, g as spread, h as escape_object, m as missing_component, i as merge_ssr_styles, j as get_store_value } from './ssr-4049a6a7.js';
import { d as derived, w as writable } from './index2-d174f90b.js';
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${validate_component(Toaster, "Toaster").$$render($$result, {}, {}, {})} <div class="back-office"> <div class="sidebar-container" data-svelte-h="svelte-1g102w5"><div class="sidebar"><div class="logo"><img src="/images/sogo-pink.png" alt="Logo de l'entreprise"></div> <ul class="menu"><li><a href="/admin/contacts">Demandes de contact</a></li> <li><a href="/admin/actualites">Actualites</a></li> <li><a href="/admin/projets">Projets</a></li></ul></div></div>  <div class="main-content"><header class="header"><div class="header-content"><button class="logout-button" data-svelte-h="svelte-1416ua3">Déconnexion</button> ${slots.buttons ? slots.buttons({ class: "btn-container" }) : ``} <a href="/" target="_blank" class="view-site-button" data-svelte-h="svelte-1w62j5o"><div>Voir le site</div></a></div></header> ${slots.default ? slots.default({}) : ``} </div> </div>`;
});

export { Layout as default };
//# sourceMappingURL=_layout.svelte-24fa0340.js.map
