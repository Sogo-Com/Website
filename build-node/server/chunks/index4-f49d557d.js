import { w as writable, d as derived } from './index2-270c726a.js';
  ...
  loaders: [
    {
      locale: "fr",
      key: "common",
      loader: async () => (await import('./common-71cf5e5b.js')).default
    },
    {
      locale: "fr",
      key: "home",
      routes: ["/"],
      loader: async () => (await import('./home-501d0f26.js')).default
    },
    {
      locale: "fr",
      key: "about",
...
new v(config);
//# sourceMappingURL=index4-f49d557d.js.map
