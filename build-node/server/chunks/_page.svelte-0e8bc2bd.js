...
const Reader = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div id="contenu">${each(blocks, (block, index) => {
    return `<div class="${"block block-" + escape(block.type, true) + " svelte-1l60tik"}">${block.type == "paragraph" ? `<p contenteditable="false">${(($$value) => $$value === void 0 ? `` : $$value)(block.data.text)}</p>` : ``}
      ...
      return `<li>${escape(item)}</li>`;
			...
			${block.type == "image" ? `<img${add_attribute("src", block.data.file.url, 0)}${add_attribute("alt", block.data.caption, 0)} class="svelte-1l60tik">
...
//# sourceMappingURL=_page.svelte-0e8bc2bd.js.map
