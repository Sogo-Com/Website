...
const Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div id="navContainer"><div class="menu-container"><a class="logo-menu" href="/"${add_attribute("this", logo, 0)} data-svelte-h="svelte-1ddonh5"><img alt="logo menu" src="/images/logo-menu.svg"></a> <div class="menu"${add_attribute("this", menu, 0)}><div class="links"${add_attribute("this", links, 0)} data-svelte-h="svelte-14qtj4f"><a href="/agence">Agence</a> <a href="/expertises">Expertises</a> <a href="/projets">Projets</a> <a href="/actualites">Actualités</a> <a href="/contact">Contact</a> <a class="mobile presse" href="/presse">Espace Presse</a></div></div> <div class="presse" data-svelte-h="svelte-1hevrxp"><a href="/presse"><div class="btn-container"><div class="btn">Espace Presse</div></div></a></div> <div class="mobile-btn"${add_attribute("this", mobileBtn, 0)} data-svelte-h="svelte-1effg8u"><span class="mob-1"></span> <span class="mob-2"></span> <span class="mob-3"></span></div></div> </div>`;
});
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header>${validate_component(Nav, "Nav").$$render($$result, {}, {}, {})}</header>`;
});
const css = {
  code: '@import url("https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Comfortaa&display=swap");@import url("/styles/reset.scss");@import url("/styles/base.scss");@font-face{font-family:"ElMessiri-Bold";src:url("/fonts/ElMessiri-Bold.ttf");font-style:normal;font-weight:700;font-display:swap}@font-face{font-family:"ElMessiri-SemiBold";src:url("/fonts/ElMessiri-SemiBold.ttf");font-style:normal;font-weight:600;font-display:swap}@font-face{font-family:"ElMessiri-Medium";src:url("/fonts/ElMessiri-Medium.ttf");font-style:normal;font-weight:500;font-display:swap}@font-face{font-family:"Poppins-Regular";src:url("/fonts/Poppins-Regular.ttf");font-style:normal;font-weight:400;font-display:swap}@font-face{font-family:"Poppins-Bold";src:url("/fonts/Poppins-Bold.ttf");font-style:normal;font-weight:700;font-display:swap}@font-face{font-family:"Poppins-SemiBold";src:url("/fonts/Poppins-SemiBold.ttf");font-style:normal;font-weight:600;font-display:swap}@font-face{font-family:"Poppins-Medium";src:url("/fonts/Poppins-Medium.ttf");font-style:normal;font-weight:500;font-display:swap}@font-face{font-family:"Poppins-Regular";src:url("/fonts/Poppins-Regular.ttf");font-style:normal;font-weight:400;font-display:swap}@font-face{font-family:"Poppins-Light";src:url("/fonts/Poppins-Light.ttf");font-style:normal;font-weight:400;font-display:swap}:root{--color-rose:#DDB0AF;--color-violet:#A48BAD;--color-jaune:#E5AE1E;--color-gris:#878787;--color-bordeaux:#9D524F;--color-bleu:#2C9A9B;--color-kaki:#80816D;--color-blanc:#F5F5F5;--color-gris-dark:#575757;--color-gris-clair:#E1E1E1;--font-primary-bold:"ElMessiri-Bold";--font-primary-semibold:"ElMessiri-SemiBold";--font-primary-medium:"ElMessiri-Medium";--font-primary-regular:"ElMessiri-Regular";--font-secondary-bold:"Poppins-Bold";--font-secondary-semibold:"Poppins-SemiBold";--font-secondary-medium:"Poppins-Medium";--font-secondary-regular:"Poppins-Regular";--font-secondary-light:"Poppins-Light";font-size:18px;--tablet:1150px;--phone:960px;--fold:359px}@media only screen and (max-width: 1150px){:root{font-size:14px}}@media only screen and (max-width: 960px){:root{font-size:12px}}@media only screen and (max-width: 359px){:root{font-size:10px}}footer.svelte-vc2sok .black.svelte-vc2sok{background-color:#575757;display:flex;justify-content:space-between;align-items:center;padding:32px 11%}@media only screen and (max-width: 960px){footer.svelte-vc2sok .black.svelte-vc2sok{flex-direction:column-reverse}}footer.svelte-vc2sok .black .logo.svelte-vc2sok{display:flex;justify-content:start;align-items:center;flex-basis:33.3%}footer.svelte-vc2sok .black .logo img.svelte-vc2sok{width:80%;height:50%}@media only screen and (max-width: 960px){footer.svelte-vc2sok .black .logo.svelte-vc2sok{margin-bottom:32px}}footer.svelte-vc2sok .black .links.svelte-vc2sok{flex-basis:33.3%;display:flex;flex-direction:row;flex-wrap:wrap}@media only screen and (max-width: 960px){footer.svelte-vc2sok .black .links.svelte-vc2sok{margin-bottom:32px}}footer.svelte-vc2sok .black .links .linkparent.svelte-vc2sok{flex-basis:50%;display:flex;align-items:center;justify-content:start}@media only screen and (max-width: 960px){footer.svelte-vc2sok .black .links .linkparent.left.svelte-vc2sok{justify-content:end}}footer.svelte-vc2sok .black .links .linkparent a.svelte-vc2sok{font-family:"Poppins-Light";font-size:1rem;color:#F5F5F5;text-decoration:none;padding:16px 0}@media only screen and (max-width: 960px){footer.svelte-vc2sok .black .links .linkparent a.svelte-vc2sok{text-align:left;width:60%}}footer.svelte-vc2sok .white.svelte-vc2sok{background-color:#F5F5F5;display:flex;justify-content:center;align-items:center;font-family:"Poppins-Light";font-size:1rem;color:#575757}@media only screen and (max-width: 960px){footer.svelte-vc2sok .white.svelte-vc2sok{justify-content:space-between;margin:0 16px}}footer.svelte-vc2sok .white a.svelte-vc2sok{padding:8px 16px;color:#575757;text-decoration:none}@media only screen and (max-width: 960px){footer.svelte-vc2sok .white a.svelte-vc2sok{padding:8px 0}}',
  map: null
};
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<footer class="svelte-vc2sok" data-svelte-h="svelte-1urtj03"><div class="black svelte-vc2sok"><a class="logo svelte-vc2sok" href="/"><img alt="logo menu" src="/images/logo-menu-black.svg" class="svelte-vc2sok"></a> <div class="links svelte-vc2sok"><div class="linkparent svelte-vc2sok"><a href="/agence" class="svelte-vc2sok">Agence</a></div> <div class="linkparent left svelte-vc2sok"><a href="/actualites" class="svelte-vc2sok">Actualités</a></div> <div class="linkparent svelte-vc2sok"><a href="/expertises" class="svelte-vc2sok">Expertises</a></div> <div class="linkparent left svelte-vc2sok"><a href="/contact" class="svelte-vc2sok">Contact</a></div> <div class="linkparent svelte-vc2sok"><a href="/projets" class="svelte-vc2sok">Projets</a></div> <div class="linkparent left svelte-vc2sok"><a href="/presse" class="svelte-vc2sok">Espace presse</a></div></div></div> <div class="white svelte-vc2sok"><a href="/mentions" class="svelte-vc2sok">Mentions légales</a>
		-
		<a href="/donnees-personelles" class="svelte-vc2sok">Données personnelles</a>
		-
		<a class="svelte-vc2sok">Préférence cookies</a></div> </footer>`;
});
...
//# sourceMappingURL=_layout.svelte-87069bca.js.map
