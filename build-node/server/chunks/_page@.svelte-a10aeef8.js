...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Layout, "Layout").$$render($$result, {}, {}, {
    ...
    default: () => {
      return `<div class="grid-view svelte-qj0nof"><h1 class="svelte-qj0nof">${escape(projets.length == 0 ? "Aucun projet" : "Liste des projets")}</h1> <table class="projet-table svelte-qj0nof"${add_attribute("style", projets.length == 0 ? "display:none;" : "", 0)}><thead data-svelte-h="svelte-hb2qvl"><tr class="svelte-qj0nof"><th class="svelte-qj0nof">Titre</th> <th class="svelte-qj0nof">Type</th> <th class="svelte-qj0nof">Date de création</th> <th class="svelte-qj0nof">Supprimer</th></tr></thead> <tbody>${each(projets, (projet, index) => {
        return `<tr class="svelte-qj0nof"><td class="svelte-qj0nof"><a href="${"/admin/projet/" + escape(projet.id, true)}" class="svelte-qj0nof">${escape(projet?.titre ?? "Aucun titre")}</a></td> <td class="svelte-qj0nof">${escape(projet?.typeProjet ?? "Aucun type")}</td> <td class="svelte-qj0nof">${escape(new Intl.DateTimeFormat("fr-FR", { dateStyle: "full", timeStyle: "long" }).format(projet?.createdAt))}</td> <td class="svelte-qj0nof"><form action="?/delete" method="POST"><input type="hidden" name="id"${add_attribute("value", projet.id, 0)}> <button type="submit" class="delete-button svelte-qj0nof" data-svelte-h="svelte-8j7lff">Supprimer</button> </form></td> </tr>`;
      })}</tbody></table></div>`;
    }
  })}`;
});
...
//# sourceMappingURL=_page@.svelte-a10aeef8.js.map
