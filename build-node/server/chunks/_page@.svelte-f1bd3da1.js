...
import Layout from './_layout.svelte-9053a269.js';
import { W as Writer } from './Writer-ce799c2a.js';
import './index2-519bc178.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Layout, "Layout").$$render($$result, {}, {}, {
      ...
      default: () => {
        return `<div><h1 data-svelte-h="svelte-16tkpwx">Formulaire d&#39;Actualité</h1> <form method="POST" action="?/create" class="actualite-form svelte-zmg6wz"><div class="form-group svelte-zmg6wz"><label for="titre" class="svelte-zmg6wz" data-svelte-h="svelte-1nxve0y">Titre</label> <input id="titre" name="titre" contenteditable="true" type="text" class="svelte-zmg6wz"${add_attribute("value", actualite.titre, 0)}></div> <div class="form-group svelte-zmg6wz"><label for="file" class="svelte-zmg6wz" data-svelte-h="svelte-1635997">Image</label> <input type="file" id="file" name="photoFile"${add_attribute("accept", [".jpg", ".jpeg", ".png", ".webp"].join(","), 0)}> ${actualite.photo != null && actualite.photo.length != 0 ? `<img${add_attribute("src", actualite.photo, 0)}${add_attribute("alt", actualite.titre, 0)} class="svelte-zmg6wz">` : ``}</div> <div class="form-group svelte-zmg6wz"><label for="redacteur" class="svelte-zmg6wz" data-svelte-h="svelte-1he7ihw">Rédacteur</label> <input id="redacteur" name="redacteur" contenteditable="true" type="text" class="svelte-zmg6wz"${add_attribute("value", actualite.redacteur, 0)}></div> <div class="form-group svelte-zmg6wz"><label for="tempsLecture" class="svelte-zmg6wz" data-svelte-h="svelte-1veys5u">Temps de Lecture (en minutes)</label> <input id="tempsLecture" name="tempsLecture" contenteditable="true" type="number" class="svelte-zmg6wz"${add_attribute("value", actualite.tempsLecture, 0)}></div> <div class="form-group svelte-zmg6wz"><label for="descriptionCourte" class="svelte-zmg6wz" data-svelte-h="svelte-ljvxfq">Description courte (200 caracteres max)</label> <textarea id="descriptionCourte" rows="3" cols="45" maxlength="200" name="descriptionCourte" contenteditable="true" type="text" class="svelte-zmg6wz">${escape(actualite.descriptionCourte || "")}</textarea></div> <div class="form-group svelte-zmg6wz"><label for="contenu" class="svelte-zmg6wz" data-svelte-h="svelte-1grqde2">Contenu</label> <div id="contenu" class="contenu svelte-zmg6wz" name="contenu" required>${validate_component(Writer, "Writer").$$render(
          $$result,
          {
          ...
          {}
        )}</div></div> <button type="submit" for="envoyer" value="envoyer" class="submit-button svelte-zmg6wz" data-svelte-h="svelte-19xtx1b">Enregistrer</button></form></div>`;
      }
    })}`;
  } while (!$$settled);
  return $$rendered;
...
//# sourceMappingURL=_page@.svelte-f1bd3da1.js.map
