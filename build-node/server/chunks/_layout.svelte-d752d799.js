import { c as create_ssr_component, v as validate_component, a as subscribe, e as escape, b as add_attribute, d as each, o as onDestroy, h as add_styles, j as spread, k as escape_object, m as missing_component, l as merge_ssr_styles, p as get_store_value } from './index3-560a1835.js';
import { d as derived, w as writable } from './index4-0a27471d.js';
...
<div class="back-office">
	<div class="sidebar-container"><div class="sidebar"><div class="logo"><img src="/images/sogo-pink.png" alt="Logo de l'entreprise"></div>
			<ul class="menu"><li><a href="/admin/contacts">Demandes de contact</a></li>
				<li><a href="/admin/actualites">Actualites</a></li>
				<li><a href="/admin/projets">Projets</a></li>
				<li><a href="/admin/collaborateurs">Collaborateurs</a></li></ul></div></div>
	

	
	<div class="main-content"><header class="header"><div class="header-content"><button class="logout-button">Déconnexion</button>
				${slots.buttons ? slots.buttons({ class: "btn-container" }) : ``}

				<a href="/" target="_blank" class="view-site-button"><div>Voir le site</div></a></div></header>
...
//# sourceMappingURL=_layout.svelte-d752d799.js.map
