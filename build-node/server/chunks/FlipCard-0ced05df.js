...
const FlipCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.link === void 0 && $$bindings.link && link !== void 0)
    $$bindings.link(link);
  $$result.css.add(css);
  return `<div class="container active svelte-1iwumgt"${add_attribute("this", container, 0)}><div id="flipcard" class="svelte-1iwumgt"${add_attribute("this", flipcard, 0)}><div class="front svelte-1iwumgt"><h3 class="svelte-1iwumgt">${escape(titre)}</h3>
				${imageSrc ? `<img${add_attribute("src", imageSrc, 0)}${add_attribute("alt", titre, 0)} class="svelte-1iwumgt">` : `<div class="placeholder svelte-1iwumgt"></div>`}</div>
			<div class="back svelte-1iwumgt"><img src="/images/bubble.png" alt="bubble" class="svelte-1iwumgt">
				<p class="svelte-1iwumgt">${escape(description)}</p></div></div>
	</div>`;
});

export { FlipCard as F };
//# sourceMappingURL=FlipCard-0ced05df.js.map
