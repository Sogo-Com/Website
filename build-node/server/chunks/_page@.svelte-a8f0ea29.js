...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(Layout, "Layout").$$render($$result, {}, {}, {
      ...
      default: () => {
        return `<div><h1 data-svelte-h="svelte-1xkiu0f">Formulaire de Projet</h1> <form method="POST" action="?/create" class="projet-form svelte-m1fmes"><div class="form-group svelte-m1fmes"><label for="titre" class="svelte-m1fmes" data-svelte-h="svelte-1nxve0y">Titre</label> <input id="titre" name="titre" contenteditable="true" type="text" class="svelte-m1fmes"${add_attribute("value", projet.titre, 0)}></div> <div class="form-group svelte-m1fmes"><label for="typeProjet" class="svelte-m1fmes" data-svelte-h="svelte-1uknwo7">Type de projet</label> <select id="typeProjet"${add_attribute("value", projet.typeProjet ?? "", 0)} name="typeProjet" required class="svelte-m1fmes"><option value="" selected disabled hidden data-svelte-h="svelte-4yr5ek">Choisissez un type...</option><option value="redaction" data-svelte-h="svelte-g2yq9s">Rédaction</option><option value="presse" data-svelte-h="svelte-xweycu">Presse</option><option value="graphisme" data-svelte-h="svelte-8mz1m6">Graphisme</option><option value="reseaux" data-svelte-h="svelte-vnrius">Réseaux</option><option value="photos" data-svelte-h="svelte-j57foi">Photos</option><option value="evenements" data-svelte-h="svelte-1g7cd5a">Evenements</option></select></div> <div class="form-group svelte-m1fmes"><label for="file" class="svelte-m1fmes" data-svelte-h="svelte-1635997">Image</label> <input type="file" id="file" name="photoFile"${add_attribute("accept", [".jpg", ".jpeg", ".png", ".webp"].join(","), 0)}> ${projet.photo != null && projet.photo.length != 0 ? `<img${add_attribute("src", projet.photo, 0)}${add_attribute("alt", projet.titre, 0)} class="svelte-m1fmes">` : ``}</div> <div class="form-group svelte-m1fmes"><label for="fileLogo" class="svelte-m1fmes" data-svelte-h="svelte-byj41n">Image Logo</label> <input type="file" id="fileLogo" name="photoLogoFile"${add_attribute("accept", [".jpg", ".jpeg", ".png", ".webp"].join(","), 0)}> ${projet.photoLogo != null && projet.photoLogo.length != 0 ? `<img${add_attribute("src", projet.photoLogo, 0)}${add_attribute("alt", projet.titre, 0)} class="svelte-m1fmes">` : ``}</div> <div class="form-group svelte-m1fmes"><label for="descriptionCourte" class="svelte-m1fmes" data-svelte-h="svelte-ljvxfq">Description courte (200 caracteres max)</label> <textarea id="descriptionCourte" rows="3" cols="45" maxlength="200" name="descriptionCourte" contenteditable="true" type="text" class="svelte-m1fmes">${escape(projet.descriptionCourte || "")}</textarea></div> <div class="form-group svelte-m1fmes"><label for="contenu" class="svelte-m1fmes" data-svelte-h="svelte-1grqde2">Contenu</label> <div id="contenu" class="contenu svelte-m1fmes" name="contenu" required>${validate_component(Writer, "Writer").$$render(
          $$result,
          {
          ...
          {}
        )}</div></div> <button type="submit" for="envoyer" value="envoyer" class="submit-button svelte-m1fmes" data-svelte-h="svelte-19xtx1b">Enregistrer</button></form></div>`;
      }
    })}`;
  } while (!$$settled);
  return $$rendered;
...
//# sourceMappingURL=_page@.svelte-a8f0ea29.js.map
