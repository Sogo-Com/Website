...
const index = 6;
let component_cache;
const component = async () => component_cache ??= (await import('./_page@.svelte-a4c93184.js')).default;
...
const stylesheets = ["_app/immutable/assets/6.403f72b4.css","_app/immutable/assets/_layout.53e7a038.css"];
const fonts = [];

export { component, fonts, imports, index, _page_server as server, server_id, stylesheets, _page as universal, universal_id };
//# sourceMappingURL=6-b372e0d4.js.map
