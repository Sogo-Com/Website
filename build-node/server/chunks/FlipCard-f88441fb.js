...
const FlipCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.link === void 0 && $$bindings.link && link !== void 0)
    $$bindings.link(link);
  $$result.css.add(css);
  return `<div class="container active svelte-18w412h"${add_attribute("this", container, 0)}><div id="flipcard" class="svelte-18w412h"${add_attribute("this", flipcard, 0)}><div class="front svelte-18w412h"><h3 class="svelte-18w412h">${escape(titre)}</h3> ${imageSrc ? `<img${add_attribute("src", imageSrc, 0)}${add_attribute("alt", titre, 0)} class="svelte-18w412h">` : `<div class="placeholder svelte-18w412h"></div>`}</div> <div class="back svelte-18w412h"><img src="/images/bubble.png" alt="bubble" class="svelte-18w412h"> <p class="svelte-18w412h">${escape(description)}</p></div></div> </div>`;
});

export { FlipCard as F };
//# sourceMappingURL=FlipCard-f88441fb.js.map
