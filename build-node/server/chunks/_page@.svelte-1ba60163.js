import { c as create_ssr_component, v as validate_component, e as escape, b as add_attribute, d as each } from './ssr-4049a6a7.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Layout, "Layout").$$render($$result, {}, {}, {
    ...
    default: () => {
      return `<div class="grid-view svelte-1tvvutb"><h1 class="svelte-1tvvutb">${escape(projets.length == 0 ? "Aucun projet" : "Liste des projets")}</h1> <table class="projet-table svelte-1tvvutb"${add_attribute("style", projets.length == 0 ? "display:none;" : "", 0)}><thead data-svelte-h="svelte-hb2qvl"><tr class="svelte-1tvvutb"><th class="svelte-1tvvutb">Titre</th> <th class="svelte-1tvvutb">Type</th> <th class="svelte-1tvvutb">Date de création</th> <th class="svelte-1tvvutb">Supprimer</th></tr></thead> <tbody>${each(projets, (projet, index) => {
        return `<tr class="svelte-1tvvutb"><td class="svelte-1tvvutb"><a href="${"/admin/projet/" + escape(projet.id, true)}" class="svelte-1tvvutb">${escape(projet?.titre ?? "Aucun titre")}</a></td> <td class="svelte-1tvvutb">${escape(projet?.typeProjet ?? "Aucun type")}</td> <td class="svelte-1tvvutb">${escape(new Intl.DateTimeFormat("fr-FR", { dateStyle: "full", timeStyle: "long" }).format(projet?.createdAt))}</td> <td class="svelte-1tvvutb"><form action="?/delete" method="POST"><input type="hidden" name="id"${add_attribute("value", projet.id, 0)}> <button type="submit" class="delete-button svelte-1tvvutb" data-svelte-h="svelte-8j7lff">Supprimer</button> </form></td> </tr>`;
      })}</tbody></table></div>`;
    }
  })}`;
});
...
//# sourceMappingURL=_page@.svelte-1ba60163.js.map
