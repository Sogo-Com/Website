...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.form === void 0 && $$bindings.form && form !== void 0)
    $$bindings.form(form);
  $$result.css.add(css);
  return `<div class="login-container svelte-t54mce"><h1 class="svelte-t54mce">Login</h1>
  <form action="?/login" method="POST" class="svelte-t54mce"><div class="form-group svelte-t54mce"><label for="email" class="svelte-t54mce">Email</label>
          <input id="email" name="email" type="text" required class="svelte-t54mce"></div>

      <div class="form-group svelte-t54mce"><label for="password" class="svelte-t54mce">Password</label>
          <input id="password" name="password" type="password" required class="svelte-t54mce"></div>

      ${form?.invalid ? `<p class="error svelte-t54mce">Email and password are required.</p>` : ``}

      ${form?.credentials ? `<p class="error svelte-t54mce">You have entered the wrong credentials.</p>` : ``}

      <button type="submit" class="svelte-t54mce">Log in</button></form>
</div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-54d1e224.js.map
