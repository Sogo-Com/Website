...
const index = 4;
let component_cache;
const component = async () => component_cache ??= (await import('./_page@.svelte-d77eeea9.js')).default;
...
const stylesheets = ["_app/immutable/assets/4.d958ae5e.css","_app/immutable/assets/2.8ae7e525.css","_app/immutable/assets/Writer.60b2678a.css"];
const fonts = [];

export { component, fonts, imports, index, _page_server as server, server_id, stylesheets, _page as universal, universal_id };
//# sourceMappingURL=4-43dbfecb.js.map
