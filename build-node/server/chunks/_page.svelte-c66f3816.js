import { c as create_ssr_component, b as add_attribute, e as escape, v as validate_component } from './index3-cf31b2df.js';
...
const css = {
  code: '@import url("https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Comfortaa&display=swap");@import url("/styles/reset.scss");@import url("/styles/base.scss");@font-face{font-family:"ElMessiri-Bold";src:url("/fonts/ElMessiri-Bold.ttf");font-style:normal;font-weight:700;font-display:swap}@font-face{font-family:"ElMessiri-SemiBold";src:url("/fonts/ElMessiri-SemiBold.ttf");font-style:normal;font-weight:600;font-display:swap}@font-face{font-family:"ElMessiri-Medium";src:url("/fonts/ElMessiri-Medium.ttf");font-style:normal;font-weight:500;font-display:swap}@font-face{font-family:"Poppins-Regular";src:url("/fonts/Poppins-Regular.ttf");font-style:normal;font-weight:400;font-display:swap}@font-face{font-family:"Poppins-Bold";src:url("/fonts/Poppins-Bold.ttf");font-style:normal;font-weight:700;font-display:swap}@font-face{font-family:"Poppins-SemiBold";src:url("/fonts/Poppins-SemiBold.ttf");font-style:normal;font-weight:600;font-display:swap}@font-face{font-family:"Poppins-Medium";src:url("/fonts/Poppins-Medium.ttf");font-style:normal;font-weight:500;font-display:swap}@font-face{font-family:"Poppins-Regular";src:url("/fonts/Poppins-Regular.ttf");font-style:normal;font-weight:400;font-display:swap}@font-face{font-family:"Poppins-Light";src:url("/fonts/Poppins-Light.ttf");font-style:normal;font-weight:400;font-display:swap}:root{--color-rose:#DDB0AF;--color-violet:#A48BAD;--color-jaune:#E5AE1E;--color-gris:#878787;--color-bordeaux:#9D524F;--color-bleu:#2C9A9B;--color-kaki:#80816D;--color-blanc:#F5F5F5;--color-gris-dark:#575757;--color-gris-clair:#E1E1E1;--font-primary-bold:"ElMessiri-Bold";--font-primary-semibold:"ElMessiri-SemiBold";--font-primary-medium:"ElMessiri-Medium";--font-primary-regular:"ElMessiri-Regular";--font-secondary-bold:"Poppins-Bold";--font-secondary-semibold:"Poppins-SemiBold";--font-secondary-medium:"Poppins-Medium";--font-secondary-regular:"Poppins-Regular";--font-secondary-light:"Poppins-Light";font-size:18px;--tablet:1150px;--phone:960px}@media only screen and (max-width: 1150px){:root{font-size:14px}}@media only screen and (max-width: 960px){:root{font-size:12px}}#top.svelte-1qr1cwq.svelte-1qr1cwq{margin-top:10%}#top.svelte-1qr1cwq h1.svelte-1qr1cwq{color:#575757;text-align:left;padding:32px 11%}#top.svelte-1qr1cwq h2.svelte-1qr1cwq{padding:0px 11%;font-size:2rem;color:#575757;text-align:left}#top.svelte-1qr1cwq .flip-container.svelte-1qr1cwq{display:flex;justify-content:end;transform:translate(0, -50px)}@media only screen and (max-width: 960px){#top.svelte-1qr1cwq .flip-container.svelte-1qr1cwq{justify-content:center;padding:32px}}@media only screen and (max-width: 1150px){#top.svelte-1qr1cwq .flip-container.svelte-1qr1cwq{transform:translate(0, -30px)}}#top.svelte-1qr1cwq .flip-container .flipcard.svelte-1qr1cwq{margin-right:25%;position:relative;width:20vw;height:20vw;transform:translateX(50%)}@media only screen and (max-width: 1150px){#top.svelte-1qr1cwq .flip-container .flipcard.svelte-1qr1cwq{margin-right:10%}}@media only screen and (max-width: 960px){#top.svelte-1qr1cwq .flip-container .flipcard.svelte-1qr1cwq{margin-right:0}}#top.svelte-1qr1cwq .flip-container .flipcard img.svelte-1qr1cwq{position:absolute;right:100%;bottom:-40%;width:200%;height:200%}@media only screen and (max-width: 960px){#top.svelte-1qr1cwq .flip-container .flipcard img.svelte-1qr1cwq{display:none}}#top.svelte-1qr1cwq .actualites.svelte-1qr1cwq{padding:32px 64px;display:flex;flex-direction:row;flex-wrap:wrap;justify-content:center;align-items:center}#top.svelte-1qr1cwq .actualites .flip-parent.svelte-1qr1cwq{flex-basis:33.3%;padding:2vw 3vw;display:flex;justify-content:center;align-items:center}@media only screen and (max-width: 1150px){#top.svelte-1qr1cwq .actualites .flip-parent.svelte-1qr1cwq{flex-basis:50%}}@media only screen and (max-width: 960px){#top.svelte-1qr1cwq .actualites .flip-parent.svelte-1qr1cwq{flex-basis:100%}}#top.svelte-1qr1cwq .actualites .flip-parent .flip-row.svelte-1qr1cwq{width:20vw;height:20vw}@media only screen and (max-width: 1150px){#top.svelte-1qr1cwq .actualites .flip-parent .flip-row.svelte-1qr1cwq{width:30vw;height:30vw}}@media only screen and (max-width: 960px){#top.svelte-1qr1cwq .actualites .flip-parent .flip-row.svelte-1qr1cwq{width:50vw;height:50vw}}',
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div id="top" class="svelte-1qr1cwq"><h1 class="svelte-1qr1cwq">Nos actualités</h1>
	<h2 class="svelte-1qr1cwq">Retrouvez notre dernier article</h2>
	<div class="flip-container svelte-1qr1cwq"><div class="flipcard svelte-1qr1cwq"><img src="/images/actualites-path.svg" alt="chemin" class="svelte-1qr1cwq">
	...
	<div><h2 class="svelte-1qr1cwq">Tous nos contenus</h2>
		<div class="actualites svelte-1qr1cwq"><div class="flip-parent svelte-1qr1cwq"><div class="flip-row svelte-1qr1cwq">${validate_component(FlipCard, "FlipCard").$$render(
    $$result,
    {
      link: "/actualites/1",
      titre: "Actu 1",
      description: "Description de l'actu n°1"
    },
    {},
    {}
  )}</div></div>
			<div class="flip-parent svelte-1qr1cwq"><div class="flip-row svelte-1qr1cwq">${validate_component(FlipCard, "FlipCard").$$render($$result, {}, {}, {})}</div></div>
			<div class="flip-parent svelte-1qr1cwq"><div class="flip-row svelte-1qr1cwq">${validate_component(FlipCard, "FlipCard").$$render($$result, {}, {}, {})}</div></div>
			<div class="flip-parent svelte-1qr1cwq"><div class="flip-row svelte-1qr1cwq">${validate_component(FlipCard, "FlipCard").$$render($$result, {}, {}, {})}</div></div>
			<div class="flip-parent svelte-1qr1cwq"><div class="flip-row svelte-1qr1cwq">${validate_component(FlipCard, "FlipCard").$$render($$result, {}, {}, {})}</div></div>
			<div class="flip-parent svelte-1qr1cwq"><div class="flip-row svelte-1qr1cwq">${validate_component(FlipCard, "FlipCard").$$render($$result, { link: "/actualites/5" }, {}, {})}</div></div>
			<div class="flip-parent svelte-1qr1cwq"><div class="flip-row svelte-1qr1cwq">${validate_component(FlipCard, "FlipCard").$$render($$result, {}, {}, {})}</div></div>
			<div class="flip-parent svelte-1qr1cwq"><div class="flip-row svelte-1qr1cwq">${validate_component(FlipCard, "FlipCard").$$render($$result, {}, {}, {})}</div></div>
			<div class="flip-parent svelte-1qr1cwq"><div class="flip-row svelte-1qr1cwq">${validate_component(FlipCard, "FlipCard").$$render($$result, {}, {}, {})}</div></div></div></div>
</div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-c66f3816.js.map
